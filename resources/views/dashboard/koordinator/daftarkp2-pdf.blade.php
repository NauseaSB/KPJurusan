                    ...
                    <tr>
                        ...
                        <td>
                            @if (isset($item->status2->s_mhs1))
                                <div class="badge"> {{ $item->status2->s_mhs1 }} </div>
                            @endif
                        </td>
                        <td>
                            @if (isset($item->status2->s_mhs2))
                                <div class="badge"> {{ $item->status2->s_mhs2 }} </div>
                            @endif
                        </td>
                        <td>
                            @if (isset($item->status2->s_kelompok))
                                <div class="badge"> {{ $item->status2->s_kelompok }} </div>
                            @endif
                        </td>
                        <td>
                            @if (isset($item->status2->s_akhir))
                                <div class="badge"> {{ $item->status2->s_akhir }} </div>
                            @endif
                        </td>
                    </tr>
                @endforeach
