                ...
                @if (isset($mahasiswa1, $mahasiswa2, $info_mhs))
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class=" form-floating mb-3">
                                <input type="text" class="form-control" name="peminatan1" id="peminatan1"
                                    placeholder="Peminatan" readonly value="{{ $info_mhs->peminatan1 }}">
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_ipk1" id="s_ipk1">
                                        <option @if ($status1->s_ipk1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_ipk1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_ipk1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_sks1" id="s_sks1">
                                        <option @if ($status1->s_sks1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_sks1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_sks1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="s_jum_d1" id="s_jum_d1">
                                        <option @if ($status1->s_jum_d1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_jum_d1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_jum_d1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class=" form-floating">
                                <input type="text"
                                    class="form-control {{ $info_mhs->jum_e1 > 0 ? 'is-invalid' : '' }}" name="jum_e1"
                                    id="jum_e1" readonly value="{{ $info_mhs->jum_e1 }}">
                            ...
                            <div class="form-floating">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="s_jum_e1" id="s_jum_e1">
                                        <option @if ($status1->s_jum_e1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_jum_e1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_jum_e1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_algoritma1" id="s_algoritma1">
                                        <option @if ($status1->s_algoritma1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_algoritma1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_algoritma1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_p_algoritma1" id="s_p_algoritma1">
                                        <option @if ($status1->s_p_algoritma1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_p_algoritma1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_p_algoritma1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_strukdat1" id="s_strukdat1">
                                        <option @if ($status1->s_strukdat1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_strukdat1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_strukdat1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_p_strukdat1" id="s_p_strukdat1">
                                        <option @if ($status1->s_p_strukdat1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_p_strukdat1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_p_strukdat1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_basdat1" id="s_basdat1">
                                        <option @if ($status1->s_basdat1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_basdat1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_basdat1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_p_basdat1" id="s_p_basdat1">
                                        <option @if ($status1->s_p_basdat1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_p_basdat1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_p_basdat1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_rpl1" id="s_rpl1">
                                        <option @if ($status1->s_rpl1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_rpl1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_rpl1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_appl1" id="s_appl1">
                                        <option @if ($status1->s_appl1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_appl1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_appl1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_progweb1" id="s_progweb1">
                                        <option @if ($status1->s_progweb1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_progweb1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_progweb1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_p_progweb1" id="s_p_progweb1">
                                        <option @if ($status1->s_p_progweb1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_p_progweb1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_p_progweb1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_po1" id="s_po1">
                                        <option @if ($status1->s_po1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_po1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_po1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_p_po1" id="s_p_po1">
                                        <option @if ($status1->s_p_po1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_p_po1 == 'Tidak Memenuhi') selected @endif value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_p_po1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_khs1" id="s_khs1">
                                        <option @if ($status1->s_khs1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_khs1 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_khs1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_krs1" id="s_krs1">
                                        <option @if ($status1->s_krs1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_krs1 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_krs1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_ktm1" id="s_ktm1">
                                        <option @if ($status1->s_ktm1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_ktm1 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_ktm1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_foto1" id="s_foto1">
                                        <option @if ($status1->s_foto1 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_foto1 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_foto1 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_ipk2" id="s_ipk2">
                                        <option @if ($status1->s_ipk2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_ipk2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_ipk2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            <div class=" form-floating">
                                <input type="text"
                                    class="form-control {{ $info_mhs->t_sks2 < 90 ? 'is-invalid' : '' }}" name="t_sks2"
                                    id="t_sks2" placeholder="Total SKS" readonly value="{{ $info_mhs->t_sks2 }}">
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_sks2" id="s_sks2">
                                        <option @if ($status1->s_sks2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_sks2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_sks2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            <div class=" form-floating mb-3">
                                <input type="text" class="form-control rounded-bottom" name="semester1"
                                    id="semester1" placeholder="Semester" readonly value="{{ $info_mhs->semester2 }}">
                                <label for="semester1">Semester</label>
                            </div>
                            <div class=" form-floating">
                                <input type="text"
                                    class="form-control {{ $info_mhs->jum_d2 > 0 ? 'is-invalid' : '' }}" name="jum_d2"
                                    id="jum_d2" readonly value="{{ $info_mhs->jum_d2 }}">
                            ...
                            <div class="form-floating">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="s_jum_d2" id="s_jum_d2">
                                        <option @if ($status1->s_jum_d2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_jum_d2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_jum_d2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class=" form-floating">
                                <input type="text"
                                    class="form-control {{ $info_mhs->jum_e2 > 0 ? 'is-invalid' : '' }}" name="jum_e2"
                                    id="jum_e2" readonly value="{{ $info_mhs->jum_e2 }}">
                            ...
                            <div class="form-floating">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="s_jum_e2" id="s_jum_e2">
                                        <option @if ($status1->s_jum_e2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_jum_e2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_jum_e2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_algoritma2" id="s_algoritma2">
                                        <option @if ($status1->s_algoritma2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_algoritma2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_algoritma2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-floating  mt-2">
                                <input type="text"
                                    ...
                                    $info_mhs->p_algoritma2 != 'C'
                                        ? 'is-invalid'
                                        : '' }}"
                                    name="p_algoritma2" id="p_algoritma2" readonly
                                    value="{{ $info_mhs->p_algoritma2 }}">
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_p_algoritma2" id="s_p_algoritma2">
                                        <option @if ($status1->s_p_algoritma2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_p_algoritma2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_p_algoritma2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_strukdat2" id="s_strukdat2">
                                        <option @if ($status1->s_strukdat2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_strukdat2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_strukdat2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_p_strukdat2" id="s_p_strukdat2">
                                        <option @if ($status1->s_p_strukdat2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_p_strukdat2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_p_strukdat2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_basdat2" id="s_basdat2">
                                        <option @if ($status1->s_basdat2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_basdat2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_basdat2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_p_basdat2" id="s_p_basdat2">
                                        <option @if ($status1->s_p_basdat2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_p_basdat2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_p_basdat2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_rpl2" id="s_rpl2">
                                        <option @if ($status1->s_rpl2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_rpl2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_rpl2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_appl2" id="s_appl2">
                                        <option @if ($status1->s_appl2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_appl2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_appl2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_progweb2" id="s_progweb2">
                                        <option @if ($status1->s_progweb2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_progweb2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_progweb2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_p_progweb2" id="s_p_progweb2">
                                        <option @if ($status1->s_p_progweb2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_p_progweb2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_p_progweb2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_po2" id="s_po2">
                                        <option @if ($status1->s_po2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_po2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_po2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_p_po2" id="s_p_po2">
                                        <option @if ($status1->s_p_po2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_p_po2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_p_po2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_khs2" id="s_khs2">
                                        <option @if ($status1->s_khs2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_khs2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_khs2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_krs2" id="s_krs2">
                                        <option @if ($status1->s_krs2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_krs2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_krs2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_ktm2" id="s_ktm2">
                                        <option @if ($status1->s_ktm2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_ktm2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_ktm2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-floating">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="s_foto2" id="s_foto2">
                                        <option @if ($status1->s_foto2 == 'Memenuhi') selected @endif value="Memenuhi">
                                            Memenuhi</option>
                                        <option @if ($status1->s_foto2 == 'Tidak Memenuhi') selected @endif
                                            value="Tidak Memenuhi">
                                            Tidak Memenuhi</option>
                                        <option @if ($status1->s_foto2 == 'Bersyarat') selected @endif value="Bersyarat">
                                            Bersyarat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="form-floating mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="proposal" id="proposal"
                                            value="Data Proposal">
                                        <a href="/storage/{{ $info_mhs->proposal }}" target="_blank"
                                ...
                                <div class="form-floating">
                                    ...
                                    bg-warning text-dark @endif"
                                        ...
                                        <select class="form-select" name="s_proposal" id="s_proposal">
                                            <option @if ($status1->s_proposal == 'Memenuhi') selected @endif value="Memenuhi">
                                                Memenuhi</option>
                                            <option @if ($status1->s_proposal == 'Tidak Memenuhi') selected @endif
                                                value="Tidak Memenuhi">
                                                Tidak Memenuhi</option>
                                            <option @if ($status1->s_proposal == 'Bersyarat') selected @endif
                                                value="Bersyarat">
                                                Bersyarat</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-floating mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="izin_kp" id="izin_kp"
                                            value="Data Izin KP">
                                        <a href="/storage/{{ $info_mhs->izin_kp }}" target="_blank"
                                            class="btn btn-primary"
                                ...
                                <div class="form-floating">
                                    ...
                                    bg-warning text-dark @endif"
                                        ...
                                        <select class="form-select" name="s_izin_kp" id="s_izin_kp">
                                            <option @if ($status1->s_izin_kp == 'Memenuhi') selected @endif value="Memenuhi">
                                                Memenuhi</option>
                                            <option @if ($status1->s_izin_kp == 'Tidak Memenuhi') selected @endif
                                                value="Tidak Memenuhi">
                                                Tidak Memenuhi</option>
                                            <option @if ($status1->s_izin_kp == 'Bersyarat') selected @endif
                                                value="Bersyarat">
                                                Bersyarat</option>
                                        </select>
                                    </div>
                    ...
                    <div class="row">
                        <table class="table table-striped table-hover table-sm mt-3 mb-3" cellpadding="10">
                            ...
                            <tr>
                                ...
                                <td> Memenuhi </td>
                                <td> {{ 42 - ($DashboardKoor::total_tidak_memenuhi($id) + $DashboardKoor::total_bersyarat($id)) }}
                                </td>
                            </tr>
                            <tr>
                                @inject('DashboardKoor', 'App\Http\Controllers\DashboardKoorController')
                                <td> Tidak memenuhi
                                <td> {{ $DashboardKoor::total_tidak_memenuhi($id) }} </td>
                            </tr>
                            <tr>
                                @inject('DashboardKoor', 'App\Http\Controllers\DashboardKoorController')
                                <td> Bersyarat
                                <td> {{ $DashboardKoor::total_bersyarat($id) }} </td>
                            </tr>
                        </table>
                    </div>
                @endif
